...
1. 若container正在运行，需要将关闭，并且commit成为新的image
   ...
   docker run -it -d --name 自定义一个名字 nvidia/cuda:10.1-cudnn7-devel-ubuntu16.04-sqc -p 10001:22 -v /home/shenqingchao/pycharmProjects/docker-remote:/home/qingchao/pycharm 
...
1. 基本介绍： 使用nvidia-gpu 可以很好的是非方便的使用gpu
