...
S	  Simple declarative clause	  简单的声明性条款
SBAR	Subordinate clause	   从句
SBARQ	Direct question introduced by wh-element	由wh元素引入的直接问题
SINV	Declarative sentence with subject-aux inversion	具有主题 - 辅助反转的陈述句
SQ	Yes/no questions and subconstituent of SBARQ excluding wh-element	是/否问题和SBARQ的子组成部分，不包括wh元素
VP	Verb phrase	动词词组
WHADVP	Wh-adverb phrase	Wh副词短语
WHNP	Wh-noun phrase	Wh名词短语
WHPP	Wh-prepositional phrase	Wh介词短语
X	Constituent of unknown or uncertain category	未知或不确定类别的组成部分
*	“Understood” subject of infinitive or imperativ	“理解”不定式或强制性的主题
0	Zero variant of that in subordinate clause	从属条款中的零变量
T	Trace of wh-Constituent	追踪wh-成分
```
